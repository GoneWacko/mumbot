...
if not _M_Murmur.__dict__.has_key('User'):
    ...
    class User(object):
        ...
        def __hash__(self):
            ...
            _h = 5 * _h + __builtin__.hash(self.prioritySpeaker)
            _h = 5 * _h + __builtin__.hash(self.selfMute)
            _h = 5 * _h + __builtin__.hash(self.selfDeaf)
            _h = 5 * _h + __builtin__.hash(self.recording)
            ...
            _h = 5 * _h + __builtin__.hash(self.udpPing)
            _h = 5 * _h + __builtin__.hash(self.tcpPing)
            return _h % 0x7fffffff

        def __lt__(self, other):
            if isinstance(other, _M_Murmur.User):
                return self.session < other.session or self.userid < other.userid or self.mute < other.mute or self.deaf < other.deaf or self.suppress < other.suppress or self.prioritySpeaker < other.prioritySpeaker or self.selfMute < other.selfMute or self.selfDeaf < other.selfDeaf or self.recording < other.recording or self.channel < other.channel or self.name < other.name or self.onlinesecs < other.onlinesecs or self.bytespersec < other.bytespersec or self.version < other.version or self.release < other.release or self.os < other.os or self.osversion < other.osversion or self.identity < other.identity or self.context < other.context or self.comment < other.comment or self.address < other.address or self.tcponly < other.tcponly or self.idlesecs < other.idlesecs or self.udpPing < other.udpPing or self.tcpPing < other.tcpPing
            elif other == None:
                return False
        ...
        def __eq__(self, other):
            if isinstance(other, _M_Murmur.User):
                return self.session == other.session and self.userid == other.userid and self.mute == other.mute and self.deaf == other.deaf and self.suppress == other.suppress and self.prioritySpeaker == other.prioritySpeaker and self.selfMute == other.selfMute and self.selfDeaf == other.selfDeaf and self.recording == other.recording and self.channel == other.channel and self.name == other.name and self.onlinesecs == other.onlinesecs and self.bytespersec == other.bytespersec and self.version == other.version and self.release == other.release and self.os == other.os and self.osversion == other.osversion and self.identity == other.identity and self.context == other.context and self.comment == other.comment and self.address == other.address and self.tcponly == other.tcponly and self.idlesecs == other.idlesecs and self.udpPing == other.udpPing and self.tcpPing == other.tcpPing
            elif other == None:
                return False
            return NotImplemented
...
if not _M_Murmur.__dict__.has_key('TextMessage'):
    ...
    class TextMessage(object):
        ...
        def __lt__(self, other):
            if isinstance(other, _M_Murmur.TextMessage):
                return self.sessions < other.sessions or self.channels < other.channels or self.trees < other.trees or self.text < other.text
            elif other == None:
                return False
            return NotImplemented
        ...
        def __eq__(self, other):
            if isinstance(other, _M_Murmur.TextMessage):
                return self.sessions == other.sessions and self.channels == other.channels and self.trees == other.trees and self.text == other.text
            elif other == None:
                return False
            return NotImplemented
...
if not _M_Murmur.__dict__.has_key('UserInfo'):
    ...
    UserInfo.UserLastActive = UserInfo(5)

    _M_Murmur._t_UserInfo = IcePy.defineEnum('::Murmur::UserInfo', UserInfo, (), (UserInfo.UserName, UserInfo.UserEmail, UserInfo.UserComment, UserInfo.UserHash, UserInfo.UserPassword, UserInfo.UserLastActive))
...
Arguments:
    ...
    ServerCallback._op_userTextMessage = IcePy.Operation('userTextMessage', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, False, (), (((), _M_Murmur._t_User), ((), _M_Murmur._t_TextMessage)), (), None, ())
...
Returns:
    ...
    Server._op_isRunning = IcePy.Operation('isRunning', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, True, (), (), (), IcePy._t_bool, (_M_Murmur._t_InvalidSecretException,))
    Server._op_start = IcePy.Operation('start', Ice.OperationMode.Normal, Ice.OperationMode.Normal, True, (), (), (), None, (_M_Murmur._t_ServerBootedException, _M_Murmur._t_ServerFailureException, _M_Murmur._t_InvalidSecretException))
    Server._op_stop = IcePy.Operation('stop', Ice.OperationMode.Normal, Ice.OperationMode.Normal, True, (), (), (), None, (_M_Murmur._t_ServerBootedException, _M_Murmur._t_InvalidSecretException))
    Server._op_delete = IcePy.Operation('delete', Ice.OperationMode.Normal, Ice.OperationMode.Normal, True, (), (), (), None, (_M_Murmur._t_ServerBootedException, _M_Murmur._t_InvalidSecretException))
    Server._op_id = IcePy.Operation('id', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, True, (), (), (), IcePy._t_int, (_M_Murmur._t_InvalidSecretException,))
    Server._op_addCallback = IcePy.Operation('addCallback', Ice.OperationMode.Normal, Ice.OperationMode.Normal, True, (), (((), _M_Murmur._t_ServerCallbackPrx),), (), None, (_M_Murmur._t_ServerBootedException, _M_Murmur._t_InvalidCallbackException, _M_Murmur._t_InvalidSecretException))
    Server._op_removeCallback = IcePy.Operation('removeCallback', Ice.OperationMode.Normal, Ice.OperationMode.Normal, True, (), (((), _M_Murmur._t_ServerCallbackPrx),), (), None, (_M_Murmur._t_ServerBootedException, _M_Murmur._t_InvalidCallbackException, _M_Murmur._t_InvalidSecretException))
    Server._op_setAuthenticator = IcePy.Operation('setAuthenticator', Ice.OperationMode.Normal, Ice.OperationMode.Normal, True, (), (((), _M_Murmur._t_ServerAuthenticatorPrx),), (), None, (_M_Murmur._t_ServerBootedException, _M_Murmur._t_InvalidCallbackException, _M_Murmur._t_InvalidSecretException))
    Server._op_getConf = IcePy.Operation('getConf', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, True, (), (((), IcePy._t_string),), (), IcePy._t_string, (_M_Murmur._t_InvalidSecretException,))
    Server._op_getAllConf = IcePy.Operation('getAllConf', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, True, (), (), (), _M_Murmur._t_ConfigMap, (_M_Murmur._t_InvalidSecretException,))
    Server._op_setConf = IcePy.Operation('setConf', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, True, (), (((), IcePy._t_string), ((), IcePy._t_string)), (), None, (_M_Murmur._t_InvalidSecretException,))
    Server._op_setSuperuserPassword = IcePy.Operation('setSuperuserPassword', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, True, (), (((), IcePy._t_string),), (), None, (_M_Murmur._t_InvalidSecretException,))
    Server._op_getLog = IcePy.Operation('getLog', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, True, (), (((), IcePy._t_int), ((), IcePy._t_int)), (), _M_Murmur._t_LogList, (_M_Murmur._t_InvalidSecretException,))
    Server._op_getLogLen = IcePy.Operation('getLogLen', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, True, (), (), (), IcePy._t_int, (_M_Murmur._t_InvalidSecretException,))
    Server._op_getUsers = IcePy.Operation('getUsers', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, True, (), (), (), _M_Murmur._t_UserMap, (_M_Murmur._t_ServerBootedException, _M_Murmur._t_InvalidSecretException))
    Server._op_getChannels = IcePy.Operation('getChannels', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, True, (), (), (), _M_Murmur._t_ChannelMap, (_M_Murmur._t_ServerBootedException, _M_Murmur._t_InvalidSecretException))
    Server._op_getCertificateList = IcePy.Operation('getCertificateList', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, True, (), (((), IcePy._t_int),), (), _M_Murmur._t_CertificateList, (_M_Murmur._t_ServerBootedException, _M_Murmur._t_InvalidSessionException, _M_Murmur._t_InvalidSecretException))
    Server._op_getTree = IcePy.Operation('getTree', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, True, (), (), (), _M_Murmur._t_Tree, (_M_Murmur._t_ServerBootedException, _M_Murmur._t_InvalidSecretException))
    Server._op_getBans = IcePy.Operation('getBans', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, True, (), (), (), _M_Murmur._t_BanList, (_M_Murmur._t_ServerBootedException, _M_Murmur._t_InvalidSecretException))
    Server._op_setBans = IcePy.Operation('setBans', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, True, (), (((), _M_Murmur._t_BanList),), (), None, (_M_Murmur._t_ServerBootedException, _M_Murmur._t_InvalidSecretException))
    Server._op_kickUser = IcePy.Operation('kickUser', Ice.OperationMode.Normal, Ice.OperationMode.Normal, True, (), (((), IcePy._t_int), ((), IcePy._t_string)), (), None, (_M_Murmur._t_ServerBootedException, _M_Murmur._t_InvalidSessionException, _M_Murmur._t_InvalidSecretException))
    Server._op_getState = IcePy.Operation('getState', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, True, (), (((), IcePy._t_int),), (), _M_Murmur._t_User, (_M_Murmur._t_ServerBootedException, _M_Murmur._t_InvalidSessionException, _M_Murmur._t_InvalidSecretException))
    Server._op_setState = IcePy.Operation('setState', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, True, (), (((), _M_Murmur._t_User),), (), None, (_M_Murmur._t_ServerBootedException, _M_Murmur._t_InvalidSessionException, _M_Murmur._t_InvalidChannelException, _M_Murmur._t_InvalidSecretException))
    Server._op_sendMessage = IcePy.Operation('sendMessage', Ice.OperationMode.Normal, Ice.OperationMode.Normal, True, (), (((), IcePy._t_int), ((), IcePy._t_string)), (), None, (_M_Murmur._t_ServerBootedException, _M_Murmur._t_InvalidSessionException, _M_Murmur._t_InvalidSecretException))
    Server._op_hasPermission = IcePy.Operation('hasPermission', Ice.OperationMode.Normal, Ice.OperationMode.Normal, True, (), (((), IcePy._t_int), ((), IcePy._t_int), ((), IcePy._t_int)), (), IcePy._t_bool, (_M_Murmur._t_ServerBootedException, _M_Murmur._t_InvalidSessionException, _M_Murmur._t_InvalidChannelException, _M_Murmur._t_InvalidSecretException))
    Server._op_effectivePermissions = IcePy.Operation('effectivePermissions', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, True, (), (((), IcePy._t_int), ((), IcePy._t_int)), (), IcePy._t_int, (_M_Murmur._t_ServerBootedException, _M_Murmur._t_InvalidSessionException, _M_Murmur._t_InvalidChannelException, _M_Murmur._t_InvalidSecretException))
    Server._op_addContextCallback = IcePy.Operation('addContextCallback', Ice.OperationMode.Normal, Ice.OperationMode.Normal, True, (), (((), IcePy._t_int), ((), IcePy._t_string), ((), IcePy._t_string), ((), _M_Murmur._t_ServerContextCallbackPrx), ((), IcePy._t_int)), (), None, (_M_Murmur._t_ServerBootedException, _M_Murmur._t_InvalidCallbackException, _M_Murmur._t_InvalidSecretException))
    Server._op_removeContextCallback = IcePy.Operation('removeContextCallback', Ice.OperationMode.Normal, Ice.OperationMode.Normal, True, (), (((), _M_Murmur._t_ServerContextCallbackPrx),), (), None, (_M_Murmur._t_ServerBootedException, _M_Murmur._t_InvalidCallbackException, _M_Murmur._t_InvalidSecretException))
    Server._op_getChannelState = IcePy.Operation('getChannelState', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, True, (), (((), IcePy._t_int),), (), _M_Murmur._t_Channel, (_M_Murmur._t_ServerBootedException, _M_Murmur._t_InvalidChannelException, _M_Murmur._t_InvalidSecretException))
    Server._op_setChannelState = IcePy.Operation('setChannelState', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, True, (), (((), _M_Murmur._t_Channel),), (), None, (_M_Murmur._t_ServerBootedException, _M_Murmur._t_InvalidChannelException, _M_Murmur._t_InvalidSecretException))
    Server._op_removeChannel = IcePy.Operation('removeChannel', Ice.OperationMode.Normal, Ice.OperationMode.Normal, True, (), (((), IcePy._t_int),), (), None, (_M_Murmur._t_ServerBootedException, _M_Murmur._t_InvalidChannelException, _M_Murmur._t_InvalidSecretException))
    Server._op_addChannel = IcePy.Operation('addChannel', Ice.OperationMode.Normal, Ice.OperationMode.Normal, True, (), (((), IcePy._t_string), ((), IcePy._t_int)), (), IcePy._t_int, (_M_Murmur._t_ServerBootedException, _M_Murmur._t_InvalidChannelException, _M_Murmur._t_InvalidSecretException))
    Server._op_sendMessageChannel = IcePy.Operation('sendMessageChannel', Ice.OperationMode.Normal, Ice.OperationMode.Normal, True, (), (((), IcePy._t_int), ((), IcePy._t_bool), ((), IcePy._t_string)), (), None, (_M_Murmur._t_ServerBootedException, _M_Murmur._t_InvalidChannelException, _M_Murmur._t_InvalidSecretException))
    Server._op_getACL = IcePy.Operation('getACL', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, True, (), (((), IcePy._t_int),), (((), _M_Murmur._t_ACLList), ((), _M_Murmur._t_GroupList), ((), IcePy._t_bool)), None, (_M_Murmur._t_ServerBootedException, _M_Murmur._t_InvalidChannelException, _M_Murmur._t_InvalidSecretException))
    Server._op_setACL = IcePy.Operation('setACL', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, True, (), (((), IcePy._t_int), ((), _M_Murmur._t_ACLList), ((), _M_Murmur._t_GroupList), ((), IcePy._t_bool)), (), None, (_M_Murmur._t_ServerBootedException, _M_Murmur._t_InvalidChannelException, _M_Murmur._t_InvalidSecretException))
    Server._op_addUserToGroup = IcePy.Operation('addUserToGroup', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, True, (), (((), IcePy._t_int), ((), IcePy._t_int), ((), IcePy._t_string)), (), None, (_M_Murmur._t_ServerBootedException, _M_Murmur._t_InvalidChannelException, _M_Murmur._t_InvalidSessionException, _M_Murmur._t_InvalidSecretException))
    Server._op_removeUserFromGroup = IcePy.Operation('removeUserFromGroup', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, True, (), (((), IcePy._t_int), ((), IcePy._t_int), ((), IcePy._t_string)), (), None, (_M_Murmur._t_ServerBootedException, _M_Murmur._t_InvalidChannelException, _M_Murmur._t_InvalidSessionException, _M_Murmur._t_InvalidSecretException))
    Server._op_redirectWhisperGroup = IcePy.Operation('redirectWhisperGroup', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, True, (), (((), IcePy._t_int), ((), IcePy._t_string), ((), IcePy._t_string)), (), None, (_M_Murmur._t_ServerBootedException, _M_Murmur._t_InvalidSessionException, _M_Murmur._t_InvalidSecretException))
    Server._op_getUserNames = IcePy.Operation('getUserNames', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, True, (), (((), _M_Murmur._t_IdList),), (), _M_Murmur._t_NameMap, (_M_Murmur._t_ServerBootedException, _M_Murmur._t_InvalidSecretException))
    Server._op_getUserIds = IcePy.Operation('getUserIds', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, True, (), (((), _M_Murmur._t_NameList),), (), _M_Murmur._t_IdMap, (_M_Murmur._t_ServerBootedException, _M_Murmur._t_InvalidSecretException))
    Server._op_registerUser = IcePy.Operation('registerUser', Ice.OperationMode.Normal, Ice.OperationMode.Normal, True, (), (((), _M_Murmur._t_UserInfoMap),), (), IcePy._t_int, (_M_Murmur._t_ServerBootedException, _M_Murmur._t_InvalidUserException, _M_Murmur._t_InvalidSecretException))
    Server._op_unregisterUser = IcePy.Operation('unregisterUser', Ice.OperationMode.Normal, Ice.OperationMode.Normal, True, (), (((), IcePy._t_int),), (), None, (_M_Murmur._t_ServerBootedException, _M_Murmur._t_InvalidUserException, _M_Murmur._t_InvalidSecretException))
    Server._op_updateRegistration = IcePy.Operation('updateRegistration', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, True, (), (((), IcePy._t_int), ((), _M_Murmur._t_UserInfoMap)), (), None, (_M_Murmur._t_ServerBootedException, _M_Murmur._t_InvalidUserException, _M_Murmur._t_InvalidSecretException))
    Server._op_getRegistration = IcePy.Operation('getRegistration', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, True, (), (((), IcePy._t_int),), (), _M_Murmur._t_UserInfoMap, (_M_Murmur._t_ServerBootedException, _M_Murmur._t_InvalidUserException, _M_Murmur._t_InvalidSecretException))
    Server._op_getRegisteredUsers = IcePy.Operation('getRegisteredUsers', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, True, (), (((), IcePy._t_string),), (), _M_Murmur._t_NameMap, (_M_Murmur._t_ServerBootedException, _M_Murmur._t_InvalidSecretException))
    Server._op_verifyPassword = IcePy.Operation('verifyPassword', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, True, (), (((), IcePy._t_string), ((), IcePy._t_string)), (), IcePy._t_int, (_M_Murmur._t_ServerBootedException, _M_Murmur._t_InvalidSecretException))
    Server._op_getTexture = IcePy.Operation('getTexture', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, True, (), (((), IcePy._t_int),), (), _M_Murmur._t_Texture, (_M_Murmur._t_ServerBootedException, _M_Murmur._t_InvalidUserException, _M_Murmur._t_InvalidSecretException))
    Server._op_setTexture = IcePy.Operation('setTexture', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, True, (), (((), IcePy._t_int), ((), _M_Murmur._t_Texture)), (), None, (_M_Murmur._t_ServerBootedException, _M_Murmur._t_InvalidUserException, _M_Murmur._t_InvalidTextureException, _M_Murmur._t_InvalidSecretException))
    Server._op_getUptime = IcePy.Operation('getUptime', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, True, (), (), (), IcePy._t_int, (_M_Murmur._t_ServerBootedException, _M_Murmur._t_InvalidSecretException))
...
Returns:
    ...
    Meta._op_getServer = IcePy.Operation('getServer', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, True, (), (((), IcePy._t_int),), (), _M_Murmur._t_ServerPrx, (_M_Murmur._t_InvalidSecretException,))
    Meta._op_newServer = IcePy.Operation('newServer', Ice.OperationMode.Normal, Ice.OperationMode.Normal, True, (), (), (), _M_Murmur._t_ServerPrx, (_M_Murmur._t_InvalidSecretException,))
    Meta._op_getBootedServers = IcePy.Operation('getBootedServers', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, True, (), (), (), _M_Murmur._t_ServerList, (_M_Murmur._t_InvalidSecretException,))
    Meta._op_getAllServers = IcePy.Operation('getAllServers', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, True, (), (), (), _M_Murmur._t_ServerList, (_M_Murmur._t_InvalidSecretException,))
    Meta._op_getDefaultConf = IcePy.Operation('getDefaultConf', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, True, (), (), (), _M_Murmur._t_ConfigMap, (_M_Murmur._t_InvalidSecretException,))
    ...
    Meta._op_addCallback = IcePy.Operation('addCallback', Ice.OperationMode.Normal, Ice.OperationMode.Normal, True, (), (((), _M_Murmur._t_MetaCallbackPrx),), (), None, (_M_Murmur._t_InvalidCallbackException, _M_Murmur._t_InvalidSecretException))
    Meta._op_removeCallback = IcePy.Operation('removeCallback', Ice.OperationMode.Normal, Ice.OperationMode.Normal, True, (), (((), _M_Murmur._t_MetaCallbackPrx),), (), None, (_M_Murmur._t_InvalidCallbackException, _M_Murmur._t_InvalidSecretException))
    Meta._op_getUptime = IcePy.Operation('getUptime', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, True, (), (), (), IcePy._t_int, ())
    Meta._op_getSlice = IcePy.Operation('getSlice', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, True, (), (), (), IcePy._t_string, ())
    Meta._op_getSliceChecksums = IcePy.Operation('getSliceChecksums', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, True, (), (), (), _M_Ice._t_SliceChecksumDict, ())
